        ...
        <div class="flex flex-col sm:flex-row justify-between items-center p-5">
            ...
            <nav class="sm:flex sm:items-center">
                <ul class="flex space-x-4">
                    ...
                    <li><a href="/signup" class="px-4 py-2 rounded bg-blue-500 text-white hover:bg-blue-600">Sign up</a></li>
                </ul>
            </nav>
        </div>
    </div>
                    ...
                    <li>
                        <div class="relative">
                            ...
                            <div class="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg hidden">
                                <ul class="py-1">
                                    <li><a href="/login-landlord" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">As Landlord</a></li>
                                    <li><a href="/login-tenant" class="block px-4 py-2 text-gray-800 hover:bg-gray-200">As Tenant</a></li>
                                </ul>
                            </div>
                        </div>
                    </li>
