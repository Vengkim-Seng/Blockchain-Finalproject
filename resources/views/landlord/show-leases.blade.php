                            ...
                            @forelse ($leases as $lease)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ asset('storage/' . $lease->lease_agreement) }}" target="_blank">
                                            <i class="fas fa-file-alt"></i> View Lease Agreement
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('leases.edit', ['lease' => $lease->lease_id]) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <form action="{{ route('leases.destroy', ['lease' => $lease->lease_id]) }}"
