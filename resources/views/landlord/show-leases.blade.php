                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            @forelse ($leases as $lease)
                                <tr>
                                    <td class="text-center">{{ $lease->tenant->tenant_name }}</td>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ asset('storage/' . $lease->lease_agreement) }}" target="_blank"><i class="fas fa-file-alt"></i> View Lease Agreement</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('leases.edit', $lease) }}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                        <form action="{{ route('leases.destroy', $lease) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure you want to delete this lease?');">
                                            @csrf
                                            @method('DELETE')
